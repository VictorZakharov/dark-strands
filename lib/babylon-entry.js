...
// Non-pure path on purpose — it runs the RegisterMaterialPluginBase() side effect
...
import '@babylonjs/core/Engines/Extensions/engine.query';            // WebGL2 captureGPUFrameTime (PERF instrumentation; WebGPU has it natively)
import '@babylonjs/core/Engines/AbstractEngine/abstractEngine.timeQuery'; // getGPUFrameTimeCounter used by the above
